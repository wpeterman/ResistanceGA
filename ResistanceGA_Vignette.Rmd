...
GA.inputs<-GA.prep(ASCII.dir=write.dir,
                   ...
                   max.cont=500,
                   run=1) 
# Note that the default value for run is 25. It is set to 1 for demonstration only. THIS WILL NOT OPTIMIZE!
...
```{r}
r.tran<-Resistance.tran(transformation="Monomolecular", shape=2, max=100, CS.inputs=CS.inputs, r=cont.rf) 
...
# Add random noise to resistance output. 
