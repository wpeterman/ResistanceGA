...
> Multi.Surface_optim.gd$percent.contribution;
      surface       mean         l95       u95
1 categorical 0.69634861 0.013726193 0.9943606
2  continuous 0.26048108 0.003151459 0.9705886
3     feature 0.04317031 0.001971552 0.3240171

> Multi.Surface_optim.gd2$percent.contribution
      surface    mean         l95       u95
1 categorical 0.71418 0.017685212 0.9963173
2  continuous 0.28582 0.003682675 0.9823148
```
...
1         categorical.continuous 5.335519e-01    1.351   649        64.9     8
2 categorical.continuous.feature 4.469329e-01    1.657   350        35.0    11
3                    categorical 1.951522e-02    2.992     1         0.1     4
4                     continuous 7.777292e-10    4.167     0         0.0     4
5                       Distance 2.620175e-10    5.127     0         0.0     2
6                        feature 2.414924e-10    5.706     0         0.0     3
```
You can see that there is decent support for the composite surface that (incorrectly) includes the feature surface, but that in 65% of bootstrap samples, the composite without the feature surface was the top model.      
...
> Summary.table
               Truth Optimized
Category1          1      1.00
Category2        250    342.55
Category3         75     91.49
Transformation     8      8.28
Shape              4      3.96
Max              150    185.43
```
```{r, eval = FALSE}
